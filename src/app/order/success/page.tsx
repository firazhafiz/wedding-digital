    ...
    <div className="min-h-screen bg-linear-to-b from-charcoal-dark to-[#1a1a2e] py-20 px-6">
      <div className="max-w-lg mx-auto text-center">
        ...
        <h1 className="font-display text-3xl md:text-4xl text-white mb-3">
          {order.payment_status === "paid" ? "Pembayaran Berhasil!" : "Pesanan Terkirim!"}
        </h1>
        ...
        <div className="flex flex-col gap-3">
          {order.payment_status !== "paid" && order.payment_url ? (
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-3 font-body text-sm font-semibold text-white bg-emerald-600/10 hover:bg-emerald-600/20 text-emerald-400 border border-emerald-500/20 px-8 py-3.5 rounded-lg transition-all duration-300"
            >
