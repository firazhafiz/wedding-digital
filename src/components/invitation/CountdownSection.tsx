...
export default function CountdownSection({ eventInfo }: CountdownSectionProps) {
  ...
  return (
    <section ref={sectionRef} className="py-8 lg:py-20 px-6 bg-off-white">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          {/* Akad */}
          <div className="gold-gradient-border rounded-sm p-8 text-center bg-white/60 backdrop-blur-sm">
            ...
            <p className="font-body text-charcoal text-sm mb-4">{akadTime}</p>
